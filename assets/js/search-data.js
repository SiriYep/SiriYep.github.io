...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "CV",
          description: "Siyuan Qian&#39;s Curriculum Vitae.",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          description: "Multi-agent research and application framework emphasizing Role-Playing, tool integration, and task automation. 15k+ GitHub stars.",
          section: "Projects",handler: () => {
              window.location.href = "/projects/1_project/";
            },},{id: "projects-ac-dit-adaptive-coordination-diffusion-transformer",
          title: 'AC-DiT: Adaptive Coordination Diffusion Transformer',
          description: "Official code for our NeurIPS 2025 paper on end-to-end VLA for mobile manipulation.",
          section: "Projects",handler: () => {
              window.location.href = "/projects/2_project/";
            },},{id: "projects-awesome-world-models",
          title: 'Awesome-World-Models',
          description: "A curated survey and resource index for World Model research. 890+ GitHub stars.",
          section: "Projects",handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%71%69%61%6E%73%69%79%75%61%6E@%73%74%75.%70%6B%75.%65%64%75.%63%6E", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/SiriYep", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=X2ekEX8AAAAJ", "_blank");
        },
      },{
        id: 'social-rss',
        title: 'RSS Feed',
