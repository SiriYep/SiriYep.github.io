...
journeyPhases:
  - kind: education
    ...
    title: 电子信息工程工学学士
    org: BUAA / 北京航空航天大学
    description: 本科就读于 **BUAA / 北京航空航天大学**电子信息工程专业，获得信息技术学院本科生最高荣誉、电子工程学院本科生最高荣誉和优秀毕业生等荣誉。
    tags:
      - 电子信息工程
      - 最高荣誉
      - 优秀毕业生
  ...
  - kind: experience
    ...
    title: 具身多模态大模型研究中心研究实习生
    org: 北京智源人工智能研究院
    description: 参与 **RoboBrain 1.0/2.0**，并共同提出端到端 VLA 移动操作框架 **AC-DiT**，在多个基准上取得 SOTA 表现。
    tags:
      - RoboBrain
      - AC-DiT
      - Mobile ALOHA
  ...
  - kind: experience
    ...
    title: 研究实习生 → 科研合作
    org: 至简动力
    description: 2025.09–2026.02 在 **联合实验室（至简动力 & 北京大学）** 担任研究实习生；自 2026.03 起以科研合作身份继续推进真实移动操纵场景中的 **VLA 部署**。
    tags:
      - 真实机器人
      - 移动操作
      - Human Data
  ...
  - kind: experience
    ...
    title: 研究实习生 → 科研合作
    org: 北京人形机器人创新中心
    description: 2026.03–2026.06 担任研究实习生；自 2026.07 起以科研合作身份继续研究面向具身世界模型的 **记忆系统** 与 **World Action Model**。
    tags:
      - 世界模型
      - 记忆系统
      - World Action Model
  ...
  - kind: experience
    ...
    title: 游戏 AI 算法研究员
    org: 米哈游
    description: 目前在米哈游担任**游戏 AI 算法研究员**。
    tags:
      - 游戏 AI
      - 研究实习
version:
...
我目前在**米哈游**担任游戏 AI 算法研究员，并继续与**至简动力**和**北京人形机器人创新中心**开展科研合作。
